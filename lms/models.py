...
class Course(models.Model):
    ...
    owner = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, related_name='courses',
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey(User, blank=True, null=True, on_delete=models.CASCADE, related_name='lessons',
                              verbose_name='Владелец')
